...
module.exports = class Clocker {
    constructor(userdb, hwdb, tabledb, bot) {
        ...
        this.clock(this.daily, this.udb, this.tdb, this.hwdb, this.bot)
        setInterval(this.clock, this.msInMinute, this.daily, this.udb, this.tdb, this.hwdb, this.bot)
    }
